$(document).ready(function(){
    ...
    $("#invoice").click(function(){
        ...
        if(total==''){
            ...
            var tablepop=$("<table id='tablepop'></table>")
            for(i=0;i<purchase.length;i++){
                
                var poptr=$("<tr>");
                var poppdtr=$("<td>").text(purchase[i].cproductName)
                var popqty=$("<td>").text(purchase[i].cproductQuantity)
                var popprice=$("<td>").text(purchase[i].cproductPrice)
                poptr.append(poppdtr,popqty,popprice)
                tablepop.append(poptr)

            }
            
            $("#popup").append(tablepop)
